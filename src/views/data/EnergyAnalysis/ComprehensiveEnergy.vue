        ...
        <a-tab-pane key="1" tab="用能统计" forceRender>
          <div>
            ...
            <a-card :bordered="true" title="用能统计">
              <div ref="container" style="width:91%;height:350px;"></div></a-card>
...
import { getOrgTreeOfEletric, getPaprBy2HDay, getPaprByDay, getAllPaprBy2H, getAllPapr } from '@/api/data/humidity'
...
export default {
    ...
    data () {
        return {
            ...
            dateString: ['2020-08-08 2:00:00', '2020-08-08 22:00:00'],
            dateString2: ['2020/07/23', '2020/07/27'],
            dateString3: ['2020-08-08 00:00:00', '2020-08-08 10:00:00'],
            dateString4: ['2020-08-08 10:00:00', '2020-08-08 20:00:00'],
            dateString5: ['2020-08-08 2:00:00', '2020-08-08 22:00:00'],
            dateString6: ['2020/07/23', '2020/07/27'],
            ...
            date1: [moment('2020-08-08 2:00:00', 'YYYY/MM/DD HH:mm:ss'), moment('2020-08-08 22:00:00', 'YYYY/MM/DD HH:mm:ss')],
            date2: [moment('2020/07/23', 'YYYY/MM/DD'), moment('2020/07/27', 'YYYY/MM/DD')],
    ...
    created () {
      getOrgTreeOfEletric().then(res => {
        this.devaddress = res[0].monitorId
        // console.log(res[0].monitorId)
        this.chart()
        this.chart3()
      })
    },
    ...
    case 2:
        ...
        queryHour () {
           getPaprBy2HDay(this.devaddress, this.dateString[0], this.dateString[1], this.level()).then(res => {
            //  console.log('小时', res)
             var xaxis = []
        var yAxis = []
        res.forEach(element => {
    ...
    series: [
        ...
        queryDate () {
          getPaprByDay(this.devaddress, this.dateString2[0], this.dateString2[1]).then(res => {
            //  console.log('小时', res)
             var xaxis = []
        var yAxis = []
        res.forEach(element => {
        ...
        var yaxis1 = []
        for (let i = 0; i < yAxis.length; i++) {
          yaxis1.push((parseFloat(this.yAxis2[i]) / parseFloat(yAxiss[i]) * 100).toFixed(4))
        }
        myChart2.setOption({
    xAxis: [
        {
    ...
    series: [
        ...
        },
        {
          ...
          getPaprByDay(this.devaddress, this.dateString6[0], this.dateString6[1]).then(res => {
            var xaxis = []
        var yAxis = []
        res.forEach(element => {
          xaxis.push(element.dataTime.substring(0, 10))
    ...
    series: [
        ...
        // 用能比较按日查询
        compareDate () {
           getPaprByDay(this.devaddress, this.dateString7[0], this.dateString7[1]).then(res1 => {
        ...
        res1.forEach(element => {
          ...
          yAxis1.push(parseFloat(element.papR))
             ...
             getPaprByDay(this.devaddress, this.dateString8[0], this.dateString8[1]).then(res2 => {
...
myChart4 = echarts.init(this.$refs.container4, 'light')
 ...
 var axisData = opt.xAxis[0].data
    ...
    var table = '<table border="1" cellspacing="0" style="width:50%;text-align:center;position:absolute;left:30%""><tbody><tr>' +
                 '<td>时间</td>' +
                 '<td>' + series[0].name + '</td>' +
                 '<td>' + series[1].name + '</td>' +
                 '</tr>'
...
var option = {
    ...
    series: [
        ...
        chart2 () {
          getAllPaprBy2H('2020-08-08 2:00:00', '2020-08-08 22:00:00', '13').then(res => {
            // console.log('占比', res)
            var xaxis = []
        var yAxis = []
        res.forEach(element => {
...
myChart2 = echarts.init(this.$refs.container2, 'light')
        ...
        chart3 () {
 getPaprBy2HDay(this.devaddress, this.dateString3[0], this.dateString3[1], this.level3()).then(res1 => {
             console.log('res1', res1)
             var xaxis1 = []
        var yAxis1 = []
        res1.forEach(element => {
          ...
          yAxis1.push(parseFloat(element.papR))
             ...
             getPaprBy2HDay(this.devaddress, this.dateString4[0], this.dateString4[1], this.level3()).then(res2 => {
               console.log('res2', res2)
                var xaxis2 = []
        var yAxis2 = []
        res2.forEach(element => {
...
myChart4 = echarts.init(this.$refs.container4, 'light')
        ...
        chart5 () {
          getPaprBy2HDay(this.devaddress, this.dateString5[0], this.dateString5[1], this.level5()).then(res => {
            // console.log(res)
            var xaxis = []
        var yAxis = []
        res.forEach(element => {
