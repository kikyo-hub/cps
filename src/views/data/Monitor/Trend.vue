    ...
    <a-card title="用能趋势">
      ...
      <a-row :gutter="8">
        ...
        <a-col :span="20">
          ...
          <a-row>
            <a-col :span="24"><div ref="container" style="width:1300px;height:500px;"></div></a-col>
            <!-- <a-col :span="24"><div ref="container2" style="width:1300px;height:500px;"></div></a-col> -->
          </a-row>
        </a-col>
      </a-row>
    </a-card>
...
import Stree from '../consumption/components/STreeMonitor'
var myChart
var myChart2
